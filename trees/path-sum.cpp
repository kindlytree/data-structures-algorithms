...
int main(){
    ...
    std::vector<int> tree = {5, 4, 11, 7, NULL, NULL, 2, NULL, NULL,NULL, 8, 13, NULL, NULL, 4, NULL, 1, NULL, NULL};
    //TreeNode* root_node_ = buildBinaryTree(root);
    TreeNode *root = NULL;
    int idx = 0;
    buildBinaryTreeRecursive(&root, tree, idx);
    int targetSum  = 22;
    bool has_target_sum_ = hasPathSum(root, targetSum);
    //int sum = 0;
    //bool has_target_sum_ = hasPathSumRecursivev2(root, sum,  targetSum);
